...
const getOrders = ()=>async (dispatch)=>{
        try {
            ...
            dispatch((0,_order_slice__WEBPACK_IMPORTED_MODULE_2__/* .getOrdersSuccess */ .w_)(data.docs.reverse()));
        } catch (e) {
...
const getProducts = ()=>async (dispatch)=>{
        try {
            ...
            dispatch((0,_product_slice__WEBPACK_IMPORTED_MODULE_2__/* .getProductsSuccess */ .Oo)(arr));
        } catch (e) {
